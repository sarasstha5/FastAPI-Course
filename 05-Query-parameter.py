...
#multiple query parameters: You can define multiple query parameters by adding more parameters to the function definition.
@app.get("/users")
def get_user(name: str=None, age: int=None):
    return{
        "user": name,
        "age": age
    }